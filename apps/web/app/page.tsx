    ...
    <div style={styles.container}>
      ...
      <main style={styles.main}>
        ...
        <p style={styles.mainDescription}>
          Create beautiful diagrams, wireframes, and sketches together in real-time. 
          Perfect for brainstorming, planning, and visual collaboration.
        </p>
        ...
        <div style={styles.featuresContainer}>
          ...
          <div style={styles.featuresGrid}>
            <div style={styles.featureItem}>
              ...
              <p style={styles.featureDescription}>Draw without limits on an infinite canvas that scales with your ideas</p>
            </div>
            <div style={styles.featureItem}>
              ...
              <p style={styles.featureDescription}>Work together seamlessly with your team in real-time</p>
            </div>
            <div style={styles.featureItem}>
              ...
              <p style={styles.featureDescription}>Export your drawings in multiple formats and share easily</p>
            </div>
          </div>
        </div>
      </section>
